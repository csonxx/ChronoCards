...
class ApiClient {
  ...
  Future<ApiResponse<PlayerRegistrationResponse>> registerPlayer(
    ...
    try {
      final response = await _client
          .post(
            Uri.parse('$_baseUrl${ApiConfig.Endpoints.registerPlayer}'),
  ...
  Future<ApiResponse<Map<String, dynamic>>> getPlayerSave(String playerId,
      {String? saveId}) async {
    try {
      var url = '$_baseUrl${ApiConfig.Endpoints.playerSave(playerId)}';
      if (saveId != null) {
        url += '?save_id=$saveId';
      }
  ...
  Future<ApiResponse<Map<String, dynamic>>> savePlayerData(
    ...
    try {
      ...
      final response = await _client
          .post(
            Uri.parse('$_baseUrl${ApiConfig.Endpoints.playerSave(playerId)}'),
            headers: ApiConfig.defaultHeaders,
  ...
  Future<ApiResponse<BattleResultResponse>> reportBattleResult({
    ...
    try {
      ...
      final response = await _client
          .post(
            Uri.parse('$_baseUrl${ApiConfig.Endpoints.battleAction}'),
            headers: ApiConfig.defaultHeaders,
            body: json.encode(body),
          )
          .timeout(ApiConfig.connectionTimeout);
  ...
  Future<ApiResponse<CardDrawResponse>> drawCard(String deckId,
    ...
    try {
      final response = await _client
          .get(
            Uri.parse(
                '$_baseUrl${ApiConfig.Endpoints.drawCard(deckId)}?count=$count'),
            headers: ApiConfig.defaultHeaders,
          )
          .timeout(ApiConfig.connectionTimeout);
  ...
  Future<ApiResponse<Map<String, dynamic>>> equipItem(
    ...
    try {
      ...
      final response = await _client
          .post(
            Uri.parse('$_baseUrl${ApiConfig.Endpoints.equipItem(playerId)}'),
            headers: ApiConfig.defaultHeaders,
            body: json.encode(body),
          )
          .timeout(ApiConfig.connectionTimeout);
  ...
  Future<ApiResponse<Map<String, dynamic>>> getReputation(
    ...
    try {
      final response = await _client
          .get(
            Uri.parse('$_baseUrl${ApiConfig.Endpoints.reputation(playerId)}'),
            headers: ApiConfig.defaultHeaders,
          )
          .timeout(ApiConfig.connectionTimeout);
